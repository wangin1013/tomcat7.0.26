...
public class SecurityListener implements LifecycleListener {
	...
	public SecurityListener() {
		log.info("构造server.xml中的SecurityListener对象");
	 ...
	 * 
	 * @param userNameList
	 *            A comma separated list of operating system users not permitted
	 *            to run Tomcat
	 */
	 ...
	 * 
	 * @param umask
	 *            The 4-digit umask as returned by the OS command <i>umask</i>
	 */
