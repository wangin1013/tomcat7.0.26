...
public class NamingResources extends LifecycleMBeanBase implements Serializable {
	...
	public NamingResources() {
		log.info("执行NamingResources的构造函数！该构造函数为空操作！");
	}
	 ...
	 */
	private HashMap<String, ContextEnvironment> envs = new HashMap<String, ContextEnvironment>();

	/**
	 * The local EJB resource references for this web application, keyed by
	 * name.
	 */
	private HashMap<String, ContextLocalEjb> localEjbs = new HashMap<String, ContextLocalEjb>();

	/**
	 * The message destination referencess for this web application, keyed by
	 * name.
	 */
	private HashMap<String, MessageDestinationRef> mdrs = new HashMap<String, MessageDestinationRef>();

	/**
	 * The resource environment references for this web application, keyed by
	 * name.
	 */
	private HashMap<String, ContextResourceEnvRef> resourceEnvRefs = new HashMap<String, ContextResourceEnvRef>();
	 ...
	 */
	private HashMap<String, ContextResourceLink> resourceLinks = new HashMap<String, ContextResourceLink>();

	/**
	 * The web service references for this web application, keyed by name.
	 */
	private HashMap<String, ContextService> services = new HashMap<String, ContextService>();
	...
	/**
	 * Return the defined EJB resource references for this application. If there
	...
	/**
	 * Return the environment entry with the specified name, if any; otherwise,
	...
	/**
	 * Return the defined local EJB resource references for this application. If
	...
	/**
	 * Return the message destination reference with the specified name, if any;
	 * otherwise, return <code>null</code>.
	 * 
	 * @param name
	...
	/**
	 * Return the resource reference with the specified name, if any; otherwise
	 * return <code>null</code>.
	 * 
	 * @param name
	...
	/**
	 * Return the resource link with the specified name, if any; otherwise
	 * return <code>null</code>.
	 * 
	 * @param name
	...
	/**
	 * Return the defined resource links for this application. If none have been
	...
	/**
	 * Return the defined resource references for this application. If none have
	...
	/**
	 * Return the resource environment reference type for the specified name, if
	...
	/**
	 * Return the set of resource environment reference names for this web
	 * application. If none have been specified, a zero-length array is
	 * returned.
	 */
	...
	/**
	 * Return the web service reference for the specified name, if any;
	 * otherwise return <code>null</code>.
	 * 
	 * @param name
	 *            Name of the desired web service
	 */
	...
	/**
	 * Return the defined web service references for this application. If none
