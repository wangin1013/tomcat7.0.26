...
public class Catalina {
	...
	protected Digester createStartDigester() {
		...
		digester.addObjectCreate("Server/Listener", null, 
				"className");
		...
		digester.addObjectCreate("Server/Service/Listener", null,
				"className");
	...
	public void load() {
		...
		try {
			log.info("使用digester工具解析server.xml文件！");
		...
		log.info("初始化处理，用时 " + ((t2 - t1) / 1000000) + " 毫秒");
