...
/**
 * Implementation of <code>LifecycleListener</code> that instantiates the set of
 * MBeans associated with global JNDI resources that are subject to management.
 * 
 * @author Craig R. McClanahan
 * @version $Id: GlobalResourcesLifecycleListener.java 1142655 2011-07-04
 *          13:28:11Z markt $
 * @since 4.1
 */
...
public class GlobalResourcesLifecycleListener implements LifecycleListener {
	 ...
	 * 
	 * @param prefix
	 *            Prefix for complete object name paths
	 * @param context
