 ...
 * must be a Context implementation to process the requests directed to a
...
public class StandardHost extends ContainerBase implements Host {
	...
	/**
	 * Return the XML root for this Host. This can be an absolute pathname, a
	 * relative pathname, or a URL. If null, defaults to ${catalina.base}/conf/
	 * directory
	 */
	@Override
	...
	/**
	 * Set the Xml root for this Host. This can be an absolute pathname, a
	 * relative pathname, or a URL. If null, defaults to ${catalina.base}/conf/
	 * directory
	 * 
	 * @param xmlBase
	 ...
	 * and xmlBase unless they already exist.
	 */
	@Override
	...
	/**
	 * Set to true if the Host should attempt to create directories for xmlBase
	 * and appBase upon startup
	 * 
	 * @param createDirs
	 */
	@Override
	 ...
	 * host's child webapps will be dynamically deployed.
	 */
	@Override
	...
	/**
	 * Return the Java class name of the context configuration class for new web
	 * applications.
	 */
	@Override
	...
	/**
	 * Return the Java class name of the Context implementation class for new
	 * web applications.
	 */
	...
	/**
	 * Set the Java class name of the Context implementation class for new web
	 * applications.
	 * 
	 * @param contextClass
	...
	/**
	 * Return the Java class name of the error report valve class for new web
	 * applications.
	 */
	...
	/**
	 * Set the Java class name of the error report valve class for new web
	 * applications.
	 * 
	...
	public void setName(String name) {
		...
		name = name.toLowerCase(Locale.ENGLISH); // Internally all names are
													// lower case
	...
	/**
	 * Set the regular expression that defines the files and directories in the
	 * host's {@link #appBase} that will be ignored by the automatic deployment
	 * process.
	 */
	@Override
		...
		public void lifecycleEvent(LifecycleEvent event) {
			if (event.getType().equals(Lifecycle.AFTER_START_EVENT)) {
				if (event.getSource() instanceof Context) {
					...
					childClassLoaders.put(context.getLoader().getClassLoader(), context.getServletContext()
							.getContextPath());
				}
			}
		}
