...
/**
 * Standard implementation of the <b>Engine</b> interface. Each child container
 * must be a Host implementation to process the specific fully qualified host
 * name of that virtual host. <br/>
...
public class StandardEngine extends ContainerBase implements Engine {
	...
	public StandardEngine() {
		...
		super();
		log.info("构造StandardEngine对象！");
		pipeline.setBasic(new StandardEngineValve());
		/* Set the jmvRoute using the system property jvmRoute */
		try {
			log.info("设置StandardEngine的jvmRoute属性值！");
	...
	/**
	 * Host name to use when no server host, or an unknown host, is specified in
	 * the request.
	 */
	...
	/**
	 * Allow the base dir to be specified explicitly for each engine. In time we
	 * should stop using catalina.base property - otherwise we loose some
	 * flexibility.
	 */
	...
	/**
	 * Disallow any attempt to set a parent for this Container, since an Engine
	 * is supposed to be at the top of the Container hierarchy.
	 * 
	 * @param container
	...
	protected synchronized void startInternal() throws LifecycleException {
		...
		log.info(sm.getString("standardEngine.start.servlet.engine.name", ServerInfo.getServerInfo()));
	...
	protected static final class AccessLogListener implements PropertyChangeListener, LifecycleListener,
			ContainerListener {
