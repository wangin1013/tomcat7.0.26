...
final class StandardWrapperValve extends ValveBase {
	...
	public final void invoke(Request request, Response response) throws IOException, ServletException {
		...
		request.setAttribute(ApplicationFilterFactory.DISPATCHER_TYPE_ATTR, dispatcherType);
		...
		try {
			...
			if (!(rootCause instanceof ClientAbortException)) {
				container.getLogger().error(
						sm.getString("standardWrapper.serviceExceptionRoot", wrapper.getName(), context.getName(),
	...
	public void event(Request request, Response response, CometEvent event) throws IOException, ServletException {
		...
		MessageBytes requestPathMB = request.getRequestPathMB();
		request.setAttribute(ApplicationFilterFactory.DISPATCHER_TYPE_ATTR, DispatcherType.REQUEST);
		request.setAttribute(ApplicationFilterFactory.DISPATCHER_REQUEST_PATH_ATTR, requestPathMB);
	...
	/**
	 * Handle the specified ServletException encountered while processing the
	 * specified Request to produce the specified Response. Any exceptions that
	 * occur during generation of the exception report are logged and swallowed.
	 * 
	 * @param request
